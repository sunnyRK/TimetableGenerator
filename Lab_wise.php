<?php
	...
	$sheet ->getCell('E2')->setValue('QR-751-2.2'.PHP_EOL.'LAB TIME TABLE');
	$sheet ->mergeCells('A3:G3');
	$sheet ->getCell('A3')->setValue('LAB TIME TABLE');
	...
	$sheet ->getCell('F5')->setValue('W.E.F.:17-07-2017');
	...
	for($i=1;$i<7;$i++)
	{
		$getClass = mysqli_query($con,"SELECT * from `timetable` WHERE `Lab_no` = '8' and `Day` = '".$i."';");
